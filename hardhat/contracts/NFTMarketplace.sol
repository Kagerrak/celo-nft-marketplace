...
contract NFTMarketplace {
    ...
    //Requires the msg.senderr is the owner of the specidied NFT
        ...
        isNFTOwner(nftAddress, tokenId)
    {
        ...
        // owner has approved marketplace contract on their behalf
        ...
        emit ListingCreateed(nftAddress, tokenId, price, msg.sender);
    }
    ...
    function cancelListing(address nftAddress, uint256 tokenId)
        ...
        isNFTOwner(nftAddress, tokenId)
    {
        // Delete the listing struc from the mapping
